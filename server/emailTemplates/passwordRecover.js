...
exports.passwordRecover = (name, link) => ({
  text: {
    pl: `<html>
    <head>${styles}</head> <body><h3>Witaj ${name}, </h3>
  ...
  <div><small>Jeśli to nie ty próbowałeś zmienić hasło, zignoruj tą wiadomość. Twoje hasło pozostanie bez zmian.<small></div></body></html>`,
    eng: `<html>
    <head>${styles}</head> <body><h3>Hi ${name}, </h3>
  <div>Please click on the following link to reset your password. <a  class="btn" href="${link}">RESET PASSWORD</a></div>
  <div><small>If you did not request this, please ignore this email and your password will remain unchanged.</small></div></body></html>`
  },
  subject: {
