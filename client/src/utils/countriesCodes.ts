...
export type CountriesKeys = keyof typeof isoCountriesEN;

type IsoCountriesObj = {
  [key in LangKey]: {
    [con in CountriesKeys]: string
  }
}

export const isoCountries: IsoCountriesObj = {
  pl: isoCountriesPL,
  eng: isoCountriesEN,
};

type countryCodeType<k extends LangKey> = keyof typeof isoCountries[k];

export const getCountryName = (countryCode: countryCodeType<"eng"> | countryCodeType<"pl">): string => {
...
export const getEnglishCountryName = (countryCode: countryCodeType<"eng">) => {
